package com.konatatatata.components;

import java.util.List;

import com.konatatatata.xFluids;
...
public class genericComponent extends Item
{
	...
	public genericComponent(String name, boolean isDisposableFluid, int maxStackSize, String desc)
	{
		...
		setTextureName(xRealisticExplosives.MODID + ":components/" + this.getUnlocalizedName().substring(5));
	}
