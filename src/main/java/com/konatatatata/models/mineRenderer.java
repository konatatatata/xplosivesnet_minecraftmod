...
public class mineRenderer extends TileEntitySpecialRenderer
{
    ...
    public mineRenderer(float rotate)
    {
            ...
            this.model = AdvancedModelLoader.loadModel(new ResourceLocation(xRealisticExplosives.MODID + ":textures/blocks/explosives/models/mine.obj"));
            this.modelTexture = new ResourceLocation(xRealisticExplosives.MODID + ":textures/blocks/explosives/models/mineTex.png");
    }
   ...
   //Use in 1.6.2  this
            ResourceLocation textures = (new ResourceLocation(xRealisticExplosives.MODID + ":textures/blocks/explosives/models/mine.png"));
