...
public class fluid_sulfuricAcid extends BlockFluidClassic
{
	...
	public fluid_sulfuricAcid(Fluid fluid, Material material)
	{
    ...
    public void onEntityCollidedWithBlock(World a, int b, int c, int d, Entity player)
    {
		...
		{
			Helper.attack(player, xplosivesnet_damageSource.poison_heavy, 3f);
		} else {
