...
public class genericDoor extends Block
{
    @SideOnly(Side.CLIENT)
	private IIcon texture_generic_top;
    @SideOnly(Side.CLIENT)
	private IIcon texture_generic_bottom;
    
    private static final String __OBFID = "CL_00000230";

    public genericDoor(String name, float hardness, float resistance)
    {
        super(Material.rock);
    ...
    {
        return this.texture_generic_top;
    }
    ...
    {
        this.texture_generic_top = icon.registerIcon(xplosivesnet.MODID + ":building/" + this.getUnlocalizedName().substring(5) + "_upper");
        this.texture_generic_bottom = icon.registerIcon(xplosivesnet.MODID + ":building/" + this.getUnlocalizedName().substring(5) + "_lower");
    }
