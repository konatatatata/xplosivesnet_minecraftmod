...
public class rocketEntity extends Entity implements IProjectile
{
    ...
    public rocketEntity(World world, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(world);
        this.renderDistanceWeight = 10.0D;
    ...
    public rocketEntity(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public void onUpdate()
    {
        ...
        if(this.worldObj.isRemote) this.worldObj.spawnParticle("smoke", this.field_145791_d, this.field_145792_e, this.field_145789_f, 0, 0, 0);
        ...
        if (this.inGround)
        {
            ...
            {
            	genericExplosion genericExplosion = new genericExplosion(this.worldObj, 0, field_145791_d, field_145792_e, field_145789_f, 5f, null, 0.5f);
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)k))
                    {
                    	...
                    	//explode
                    	genericExplosion genericExplosion = new genericExplosion(this.worldObj, 0, movingobjectposition.entityHit.posX , movingobjectposition.entityHit.posY, movingobjectposition.entityHit.posZ, 5f, null, 0.5f);
                    	this.worldObj.spawnEntityInWorld(genericExplosion);
                    	this.setDead();
